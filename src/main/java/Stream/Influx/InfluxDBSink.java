...
public class InfluxDBSink<T extends DataPoint<? extends Number>> extends RichSinkFunction<T> {
  ...
  private static String dataBaseName = "testCEPNew";
  private static String fieldName = "value1";
  private static String fieldName2 = "value2";
  private String type;
   ...
   * @param dbName
   */
  public InfluxDBSink(String dbName){
  ...
  public void invoke(T dataPoint) throws Exception {
    Point.Builder builder = Point.measurement(dataPoint.getType().substring(1,3))
