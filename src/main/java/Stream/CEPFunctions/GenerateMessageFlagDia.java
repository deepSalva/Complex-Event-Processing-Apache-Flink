...
public class GenerateMessageFlagDia implements PatternSelectFunction<Tuple7<String, String, Double, Double, Long, Long, String>, String> {
    int FLAG_VAL;
    public GenerateMessageFlagDia(int flag){
        this.FLAG_VAL = flag;
    }
    @Override
    public String select(Map<String, List<Tuple7<String, String, Double, Double, Long, Long, String>>> pattern) throws Exception {
        ...
        String msg = "{\"MACSSID\": "+flag.f0+", \""+ concat +"\": "+flag.f1+", \"ValueDiastolic\": "+ flag.f3+", \"Flag\": "+ FLAG_VAL + ",\"Date\": "+flag.f5+",\"Type\": "+flag.f6+"}";
        return msg;
    }
}
